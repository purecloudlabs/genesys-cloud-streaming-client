...
* [STREAM-518](https://inindca.atlassian.net/browse/STREAM-518) - Update stanza sent when sending the extension discovery request for agent-video to include the full JID from the JWT.
